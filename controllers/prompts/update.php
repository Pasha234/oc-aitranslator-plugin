    ...
    <div class="form-buttons">
        <div class="loading-indicator-container">
            ...
            <button
                ...
                <span class="btn-text">
                    <?= e(trans('backend::lang.form.or')) ?> <a href="<?= Backend::url('palpalych/aitranslator/prompts') ?>"><?= e(trans('backend::lang.form.cancel')) ?></a>
                </span>
        </div>
    </div>
</div>
...
<div class="padded-container">
    ...
    <p><a href="<?= Backend::url('palpalych/aitranslator/prompts') ?>" class="btn btn-default"><?= e(trans('backend::lang.form.return_to_list')) ?></a></p>
</div>
